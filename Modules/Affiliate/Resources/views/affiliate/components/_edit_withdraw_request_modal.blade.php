                    ...
                    @if($transaction->payment_type == 3)
                        ...
                        <div class="col-lg-12">
                            <div class="primary_input mb-25">
                                ...
                                <input step="0.01" autocomplete="off" name="transfer_amount" id="transfer_amount" value="{{$transaction->withdraw_amount}}" class="primary_input_field" placeholder="{{__('affiliate.Transfer Amount') }}" type="number">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input step="0.01" autocomplete="off" name="withdraw_amount" id="withdraw_amount" value="{{$transaction->withdraw_amount}}" class="primary_input_field"  type="number">
                            ...
                            <div class="col-lg-6">
                                <div class="primary_input mb-15">
                                    ...
                                    <select  class="primary_select mb-15" id="payment_type" name="payment_type">
                                        ...
                                        <option {{$transaction->payment_type == 1 ?'selected' :''}} value="1">{{__('affiliate.Offline')}}</option>
                                        @if(isset($paypal_account))
                                            <option {{$transaction->payment_type == 2 ?'selected' :''}} value="2">{{__('affiliate.Paypal')}}</option>
                                        @endif
                                    </select>
